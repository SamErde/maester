...
description: Checks if Spam confidence level (SCL) is configured in mail transport rules with specific domains
id: Test-MtExoSetScl
title: Test-MtExoSetScl
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtExoSetScl.ps1
---
...
```powershell
Test-MtExoSetScl [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://maester.dev/docs/commands/Test-MtExoSetScl](https://maester.dev/docs/commands/Test-MtExoSetScl)
