...
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtEidscaAF06.ps1
---
...
```powershell
Test-MtEidscaAF06 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
