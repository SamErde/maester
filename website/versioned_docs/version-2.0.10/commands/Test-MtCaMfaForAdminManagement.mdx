...
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtCaMfaForAdminManagement.ps1
---
...
```powershell
Test-MtCaMfaForAdminManagement [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION

MFA for Azure management is a critical security control.
...
[https://maester.dev/docs/commands/Test-MtCaMfaForAdminManagement](https://maester.dev/docs/commands/Test-MtCaMfaForAdminManagement)
