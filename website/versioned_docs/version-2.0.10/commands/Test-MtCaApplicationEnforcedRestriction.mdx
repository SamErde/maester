...
id: Test-MtCaApplicationEnforcedRestriction
title: Test-MtCaApplicationEnforcedRestriction
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtCaApplicationEnforcedRestriction.ps1
---
...
```powershell
Test-MtCaApplicationEnforcedRestriction [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://maester.dev/docs/commands/Test-MtCaApplicationEnforcedRestriction](https://maester.dev/docs/commands/Test-MtCaApplicationEnforcedRestriction)
