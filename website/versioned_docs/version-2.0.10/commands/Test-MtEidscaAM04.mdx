...
description: Checks if Authentication Method - Microsoft Authenticator - Included users/groups of number matching for push notifications is set to 'all_users'
id: Test-MtEidscaAM04
title: Test-MtEidscaAM04
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtEidscaAM04.ps1
---
...
```powershell
Test-MtEidscaAM04 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
